...
namespace LegacyUserSystem.Persistence.Migrations
{
    ...
    [Migration("20250220160757_Initial_Migration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LegacyUserSystem.Entities.AppRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LegacyUserSystem.Entities.AppUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("LegacyUserSystem.Entities.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("LegacyUserSystem.Entities.AppUser", null)
                        .WithMany()
